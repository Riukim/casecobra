...
const OrderReceivedEmail = ({
  ...
  const baseUrl =
    process.env.NODE_ENV === "development"
      ? "http://localhost:3000n"
      : "https://casecobra-liard-one.vercel.app"
        ...
        <Container style={container}>
          <Section style={message}>
            ...
            <Text style={global.text}>
              We're preparing for delivery and will notify you once your package
              has been shipped. Delivery usually takes 2 days.
            </Text>
