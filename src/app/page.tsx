...
import snakeLogo from "/public/snake-1.png"
          ...
          <div className="mx-auto grid max-w-2xl grid-cols-1 px-4 lg:mx-0 lg:max-w-none lg:grid-cols-2 gap-y-16">
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  &quot;The case feels durable and I even got a compliment on the design. Had the case for two and a half months now and <span className="p-0.5 bg-slate-800 text-white">the image is super clear</span>, on the case i had before, the image started fading into yellow-ish colour after a couple of weeks. Love it.&quot;
                </p>
              </div>
            ...
            <div className="flex flex-auto flex-col gap-4 lg:pr-8 xl:pr-20">
              ...
              <div className="text-lg leading-8">
                <p>
                  ...
                  <span className="p-0.5 bg-slate-800 text-white">looks brand new after half a year</span>. I dig it!&quot;
                </p>
              </div>
              <div className="flex gap-4 mt-2">
                <img
